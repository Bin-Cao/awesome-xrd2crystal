...
> [!TIP]
> ## ✨ Explora el mapa bibliográfico interactivo
> **[Abrir XRD-to-Crystal Explorer con búsqueda →](https://bin-cao.github.io/awesome-xrd2crystal/)**
>
> Este sitio es la versión interactiva de [`index.html`](index.html) de este repositorio: permite buscar toda la colección y filtrar las entradas por área de investigación o año.
...
El problema PXRD a estructura es un problema inverso mal condicionado. Para evitar errores en títulos, autores, afiliaciones y resúmenes técnicos, las entradas bibliográficas se mantienen en inglés.
...
## Clasificación y Generación: Guía Rápida

Dos formulaciones complementarias aparecen a lo largo de esta lista. Elige la sección que mejor encaje con tu tarea:

| Tarea | Entrada | Salida | Secciones |
|---|---|---|---|
| **Identificación de fase / estructura** (clasificación, recuperación) | Patrón PXRD | Índice de una fase conocida, sistema cristalino o grupo espacial | [Identificación de Fases](#phase-identification-from-xrd) · [Sistema Cristalino / Grupo Espacial / Red](#crystal-system--space-group--lattice-prediction-from-xrd) |
| **Descomposición multifase** | Patrón PXRD mixto | Fracciones de peso por fase y patrones de componentes | [Descomposición Multifase y Rietveld](#multi-phase-decomposition--rietveld-refinement) |
| **Generación ab-initio de estructuras** | Patrón PXRD (± composición / celda) | Cristal 3D completo (especies atómicas + coordenadas fraccionarias + red / CIF) | [PXRD a Estructura Cristalina End-to-End (Generativo)](#end-to-end-pxrd--crystal-structure-generative) |
| **Análisis autónomo / in-situ** | Flujo PXRD en vivo de línea de luz / laboratorio | Identificación de fases, política de próxima medición, decisiones de síntesis | [XRD Autónomo / In-situ](#autonomous--in-situ-xrd-analysis) |

Los modelos de clasificación suelen ser más ligeros, no requieren necesariamente equivariancia de simetría y se degradan de forma más gradual fuera de distribución; los modelos generativos apuntan a estructuras de resolución atómica, pero dependen de priors físicos más fuertes y siguen limitados por la cobertura del conjunto de entrenamiento.

---

## Índice

- [Descripción General](#overview-localized)
- [Responsables](#maintainers)
- [Clasificación y Generación: Guía Rápida](#classification-vs-generation--quick-guide)
- [Formato Estándar de Entrada](#standard-entry-format)
- [PXRD a Estructura Cristalina End-to-End (Generativo)](#end-to-end-pxrd--crystal-structure-generative)
- [Identificación de Fases desde XRD](#phase-identification-from-xrd)
- [Predicción de Sistema Cristalino / Grupo Espacial / Red desde XRD](#crystal-system--space-group--lattice-prediction-from-xrd)
- [Descomposición Multifase y Refinamiento Rietveld](#multi-phase-decomposition--rietveld-refinement)
- [Análisis XRD Autónomo / In-situ](#autonomous--in-situ-xrd-analysis)
- [Datasets y Benchmarks](#datasets--benchmarks)
- [Herramientas de Simulación, Refinamiento y Utilidad](#simulation-refinement-and-utility-tools)
- [Revisiones y Surveys](#reviews--surveys)
- [Listas Curadas Relacionadas](#related-curated-lists)
...
## PXRD a Estructura Cristalina End-to-End (Generativo)

Métodos que toman un patrón PXRD (opcionalmente composición / red) y producen una estructura cristalina 3D completa (posiciones atómicas + red, normalmente como CIF o coordenadas).
...
## Identificación de Fases desde XRD

Métodos que, dado un patrón PXRD, predicen a qué fase(s) conocida(s) corresponde (clasificación / multietiqueta / identificación uno a uno).
...
## Predicción de Sistema Cristalino / Grupo Espacial / Red desde XRD
...
## Descomposición Multifase y Refinamiento Rietveld
...
Listado en orden cronológico. *(Las bases de datos de referencia, como RRUFF, COD, Materials Project, ICSD y JARVIS-DFT, se agrupan al final.)*
...
### Bases de datos estructurales de referencia
...
## Herramientas de Simulación, Refinamiento y Utilidad
...
Revisiones centradas directamente en análisis y determinación estructural guiados por PXRD:
...
Revisiones más amplias sobre CSP cristalino y modelos generativos (contexto para los métodos anteriores):
...
**Se agradecen nuevas entradas, correcciones y traducciones.**

Hay tres formas sencillas de contribuir:

- **[Abrir un issue](https://github.com/Bin-Cao/awesome-xrd2crystal/issues/new)** — pega el título del paper, el id de arXiv o el enlace de GitHub y, si es posible, la sección correspondiente.
- **Abrir un Pull Request** — edita el README siguiendo el formato descrito en [CONTRIBUTING.md](CONTRIBUTING.md).
- **Enviar un correo al maintainer** — útil para adiciones grandes, por ejemplo una línea de investigación faltante.

Consulta [CONTRIBUTING.md](CONTRIBUTING.md) para la plantilla completa, las reglas cronológicas y las convenciones de enlaces.
...
Gracias a quienes han contribuido papers, correcciones y mejoras a esta lista:
...
<sub>*Los avatares se generan automáticamente con [contrib.rocks](https://contrib.rocks) a partir del grafo de contribuidores de GitHub.*</sub>
